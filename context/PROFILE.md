...
- **ML/GenAI:** Scikit-learn, TensorFlow, HuggingFace, LangChain, LangGraph, Pydantic AI, SmolAgents.
- **Tech Stack:** GCP, Azure, Docker, FastAPI, Git, GitLab/GitHub CI/CD, Poetry, Dataiku, uv.
- **Certifications:** GCP Professional ML Engineer, TensorFlow Developer, 6x Dataiku Certified (GenAI, Core, Advanced, Developer, ML, MLOps).

## 3. PROJECTS & OPEN SOURCE
**GitHub Repositories:**
- **Portfolio Website:** Static-first Astro/Bun site; serverless stateless AI assistant (TogetherAI).
- **Agentic Data Explorer:** Agent converting questions to SQL using DB metadata, generating visuals.
- **Framelaw:** Fast, expressive schema-based validation for Polars DataFrames in Rust.
- **Distill ModernBERT Embedding** Model2Vec distilled embedding models for sentence similarity.
- **Comments Checker:** Pre-commit checker for specific Python comments (TODO, BUG) in Go.
- **Vidscribe:** YouTube monitor and Gemini-based video summarizer in Go.

**Hugging Face Models:**
Collection of Model2Vec Distilled Models (Sentence Similarity optimized for CPU low inference latency):
- `adrien-riaux/distill-modernbert-embed-large`
- `adrien-riaux/distill-modernbert-embed-base`
- `adrien-riaux/distill-multilingual-mpnet-base`
- `adrien-riaux/distill-multilingual-minilm-l12`

**Kaggle (Notebooks Expert - +220 upvotes):**
- **6 Bronze Medals:** Stacking regressor, Siamese Encoder-Decoder with Attention, LightGBM and SMOTE with Optuna, Blender Neural Networks (TF), HistGradientBoosting with Optuna, PCA & SVM on MNIST.
- **Other Notable Work:** Finetune Gemma using LoRA, Time series forecasting (CNN/LightGBM), CNN custom training loops, Transfer Learning.

**Medium Publications:**
- Python Parallel Computing — An ML Perspective
- Long Context LLMs — A Game Changer
- Understanding PEFT — Using adapter techniques
- One Tool To Rule Them All — UV
- Mastering HistGBM — Sklearn Implementation
- Comment Checker — A Python Pre-commit
- Mastering Git — Documentation and Usage

## 4. EDUCATION & BACKGROUND
- **Degrees:** EFREI Paris (Engineering, 2017-2023), Grenoble INP-ENSIMAG (ML/DL), Grenoble École de Management. Exchange semesters in South Africa & Denmark.
- **Languages:** French (Native), English (B2+).
- **Interests:** Sports, Travel, Formula One.
